...
if (length(args) < 5) {
    cat("\nUsage: <param> <pc_dir> <silh_dir> <obj> <out.tsv>\n")
    cat("\n<param>      file with clustering parameters\n")
    cat("<pc_dir>     input directory containing the list of genes and the results of PCs selection\n")
    cat("<silh_dir>   input directory containing the results of clusters validation\n")
    cat("<obj>        object containing clustering solutions\n")
